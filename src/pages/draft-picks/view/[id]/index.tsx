...
import { getDraftPickById } from 'apiSdk/draft-picks';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Draft Pick Detail View
          </Text>
          {hasAccess('draft_pick', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/draft-picks/edit/${data?.id}`} passHref legacyBehavior>
              <Button
